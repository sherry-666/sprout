  ...
  en: {
    translation: {
      ...
      registerKid: {
        ...
        reviewNote: "Once confirmed, the child will be registered and activation emails sent to new parents.",
        edit: "Go Back & Edit",
  ...
  zh: {
    translation: {
      ...
      registerKid: {
        ...
        cancel: "取消",
        reviewTitle: "审核并确认",
        reviewNote: "确认后，孩子将被注册，激活邮件将发送给新家长。",
        edit: "返回编辑",
  ...
  fr: {
    translation: {
      ...
      registerKid: {
        ...
        reviewNote: "Une fois confirmé, l'enfant sera inscrit et les emails d'activation envoyés aux nouveaux parents.",
